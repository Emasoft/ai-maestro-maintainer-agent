...
| maintainer-memory-recall / -write (memgrep + fallback) | 5 | `test_memory_skills.py` |
...
**538 tests total.** Each test has a one-line docstring used by the runner
...
├── test_memory_skills.py   # memgrep recall/write + grep fallback
